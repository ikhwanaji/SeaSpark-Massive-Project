        ...
        <div className="container mt-8 mx-auto px-4">
          <div className="bg-white p-8 rounded-lg shadow-lg flex flex-col md:flex-row items-center max-w-[800px] mx-auto">
            ...
            <div className="w-full md:w-1/2 md:pl-8">
              ...
              <p className="text-blue-500 mb-4">Silahkan tinggalkan pesan Anda pada kolom dibawah ini</p>

              <form onSubmit={handleSubmit}>
                <div className="mb-4">
                  <label className="block text-blue-500 mb-2 font-semibold" htmlFor="fullName">
                    Nama Lengkap
                  </label>
                ...
                <div className="mb-4">
                  <label className="block text-blue-500 mb-2 font-semibold" htmlFor="message">
                    Pesan / Pengaduan
                  </label>
                ...
                <button
                  ...
                  onClick={() => window.location.href = '/sukses'}
                >
                  Kirim
                </button>
              </form>

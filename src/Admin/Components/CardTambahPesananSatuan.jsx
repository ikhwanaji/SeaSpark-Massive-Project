...
const CardTambahPembelianSatuan = () => {
  return (
    <div className="border rounded-md p-6 bg-white shadow-lg">
      <h2 className="text-2xl text-sky-900 font-bold mb-4">Tambah Pembelian Satuan</h2>
      <hr />
      <div className="grid grid-cols-2 gap-6 mt-6">
        ...
        <div className="flex flex-col gap-4">
          <div>
            <label className="block text-sky-900 font-semibold mb-2">Jumlah Barang</label>
            <input
              type="number"
          ...
          <div>
            <label className="block text-sky-900 font-semibold mb-2">Jenis Barang</label>
            <select className="p-2 border rounded-md w-full shadow-md mb-2 border-sky-900">
              <option>Obat Jamur</option>
              <option>Obat Bakteri</option>
              <option>Obat Parasit</option>
            </select>
          </div>
          <div>
...
export default CardTambahPembelianSatuan;

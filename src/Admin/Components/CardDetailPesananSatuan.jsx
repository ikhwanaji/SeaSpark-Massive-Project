      ...
      <div className="grid grid-cols-2 gap-6 mt-6">
        <div className="flex flex-col gap-4">
          ...
          <div>
            ...
            <select className="p-2 border rounded-md w-full shadow-md mb-2 border-sky-900" defaultValue="Status1" disabled>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div>
            ...
            <select className="p-2 border rounded-md w-full shadow-md mb-2 border-sky-900" defaultValue="OBakteri" disabled>

...
const CardPesananSatuan = () => {
  return (
    <div className="border rounded-md p-4 mb-8 bg-white shadow">
      {/* Card Title */}
      <h2 className="text-2xl text-sky-900 font-bold mb-4">Manajemen Pesanan Satuan</h2>
      <hr />
      <div className="flex justify-between items-center mb-4 mt-6">
        ...
        <thead>
            ...
            <th className="border border-sky-900 p-2 text-sky-900">Jenis Barang</th>
        ...
        <tbody>
            ...
            <td className="border border-sky-900 p-2 text-sky-900">Obat Bakteri</td>
            <td className="border border-sky-900 p-2 text-sky-900 text-center">1</td>
            ...
            <td className="border border-sky-900 p-2 text-sky-900">Obat Jamur</td>
            <td className="border border-sky-900 p-2 text-sky-900 text-center">1</td>
